...
def click():
    ...
    if  list[0] == '' :
        ...
        Error_Message.pack(relx = 0.5, rely = 0.5, anchor = "center")
        ...
        for i in range(len(list)):
            ...
            name = list[i]
            button_ = Button(frame,text = name , font = ("Helvetica", 12), width = 16, bg = "white" , fg = "black", command= partial(create_win, name))
